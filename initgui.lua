return function(UI)
	...
	ui.rtItemBtn = UI("TextButton", { Size = UDim2.new(0, 50, 1, 0), Position = UDim2.new(1, -260, 0, 0), BackgroundColor3 = Color3.new(0.6, 0.2, 0.6), TextColor3 = Color3.new(1, 1, 1), Text = "RTItems", Font = Enum.Font.Code, TextSize = 12, BorderSizePixel = 0 })
	ui.titleBar = UI("TextLabel", { Size = UDim2.new(1, 0, 0, 25), BackgroundColor3 = Color3.new(0.05, 0.05, 0.05), TextColor3 = Color3.new(1, 1, 1), Text = " RoEditor [F3 Toggle]", TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.Code, TextSize = 14, Active = true, ui.killBtn, ui.minBtn, ui.refreshBtn, ui.monitorBtn, ui.clinkerBtn, ui.rtItemBtn })
