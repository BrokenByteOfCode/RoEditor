return function(UI)
	...
	ui.titleBar = UI("TextLabel", { Size = UDim2.new(1, 0, 0, 25), BackgroundColor3 = Color3.new(0.05, 0.05, 0.05), TextColor3 = Color3.new(1, 1, 1), Text = " RoEditor [F3 Toggle]", TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.Code, TextSize = 14, Active = true, ui.killBtn, ui.minBtn, ui.refreshBtn, ui.monitorBtn, ui.clinkerBtn })
