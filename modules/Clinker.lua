return function(UI)
	return function(mainGui, globalConnections, RunService, fs)
		...
		local titleBar = UI("Frame", { Size = UDim2.new(1, 0, 0, 25), BackgroundColor3 = Color3.fromRGB(50, 50, 55),
			...
			UI("TextButton", { Size = UDim2.new(0, 25, 1, 0), Position = UDim2.new(1, -50, 0, 0), BackgroundColor3 = Color3.fromRGB(60, 120, 200), Text = "-", TextColor3 = Color3.new(1,1,1), TextScaled = true, Events = { MouseButton1Click = function(self) local b = self.Text == "-" self.Text = b and "+" or "-" frame.Size = UDim2.new(0, 400, 0, b and 25 or 320) end } })
		})
		...
		for i, u in ipairs(state.clickUpgrades) do
			UI("TextButton", { Size = UDim2.new(1, -10, 0, 50), BackgroundColor3 = Color3.fromRGB(60, 50, 70), Parent = upgTab, UI("TextLabel", { BackgroundTransparency = 1, Position = UDim2.new(0, 10, 0, 5), Size = UDim2.new(1, -20, 0, 20), TextColor3 = Color3.new(1,1,1), Font = Enum.Font.GothamBold, TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true, Text = u.name .. " (+" .. u.power .. " Click)" }), UI("TextLabel", { BackgroundTransparency = 1, Position = UDim2.new(0, 10, 0, 25), Size = UDim2.new(1, -20, 0, 20), TextColor3 = Color3.fromRGB(255, 200, 100), Font = Enum.Font.Gotham, TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true, Text = "Cost: $" .. u.cost }), Events = { MouseButton1Click = function(btn) if not u.bought and state.cash >= u.cost then state.cash = state.cash - u.cost u.bought = true btn.Visible = false saveState() end end } })
		end
